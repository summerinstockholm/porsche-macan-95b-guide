...
- для 95B.2 таблица моторных масел доведена до MY2021: **C20** для Base/S и **C30** для GTS/Turbo; отдельно зафиксировано требование Porsche использовать только масла `0W-...` с MY2021;
- в `REFERENCES.md` добавлены официальный Porsche TSB по болтам/течи крышки ГРМ и официальные Porsche allocation/approved-oil bulletins для моторных масел;
