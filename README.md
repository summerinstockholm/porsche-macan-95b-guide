...
|---|---|---|---:|---|---|---|---|
| **Macan** | **2.0 R4 бензин, turbo** | **CYP / EA888** | **252 л.с. (РФ)** | AWD | 7PDK | 🟢 Классические Alusil-задиры не характерны | 🟢/🟡 |
| **Macan 2.0, ранний импорт** | **2.0 R4 бензин, turbo** | **CNC / EA888** | **237 л.с.** | AWD | 7PDK | 🟢 Классические Alusil-задиры не характерны | 🟢/🟡 |
...
> Для РФ базовый 2.0 официально появился в 2016 году в версии **252 л.с. CYP**. Ранний **237-сильный CNC** выпускался в 2014–2016 годах прежде всего для японского рынка и встречается в РФ как импорт.
>
> Коды `CNC/CYP/CTM/DCN/CTL/DHK` часто встречаются как VAG/рынковые engine codes; Porsche-обозначения вроде `MCT.MA/MCT.LA` зависят от рынка. На конкретной машине финально проверять VIN/наклейку агрегатов/PIWIS.

## Что здесь происходит

### 2.0 turbo 237/252 — EA888

Самый рациональный бензиновый Macan дорестайла. Для российского рынка основной ориентир — **252-сильный CYP**; ранний **237-сильный CNC** — прежде всего импортный вариант.
...
> Ранние импортные `2.0 237 CNC` в строку `2.0 252 (РФ)` **не смешиваются автоматически**: происхождение, правый/левый руль, история ввоза и спецификация конкретной машины заметно влияют на цену.
...
| **95B.2 Base 2.0** | **Porsche C20, MY2019–2021** | 0W-20 | **≈5.2 л** |
| **95B.2 S 3.0 EA839** | **Porsche C20, MY2019–2021** | 0W-20 | **≈7.5 л** |
| **95B.2 GTS/Turbo 2.9 EA839** | **Porsche C30, MY2019–2021** | 0W-30 / 5W-30 (MY2019–2020); **0W-30 для MY2021** | **≈7.5 л** |

> В Porsche allocation для Macan II до MY2020 указаны **C20 для Base/S** и **C30 для GTS/Turbo**. Для MY2021 семейства допусков те же, но Porsche отдельно требует использовать только масла класса **0W-...**. Конкретный продукт сверять по актуальному Porsche approved-oil list и VIN.
...
**2.0 237 (ранний импорт) / 252 (РФ)** → рациональный EA888 → нет классического Alusil-risk → следим за охлаждением/PCV/цепью.  
...
**95B.1:** `237 ранний импорт / 252 РФ → Diesel 245 → S 340 → GTS 360 → Turbo 400 → Turbo Performance 440`
